...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "h", function () awful.screen.focus_relative(-1) end, {description = "focus the next screen", group = "screen"}),
    awful.key({ modkey,           }, "l", function () awful.screen.focus_relative( 1) end, {description = "focus the previous screen", group = "screen"}),
    ...
    awful.key({ modkey              , "Shift"     , "Control" }                                              , "q"                                         , awesome.quit                                  , {description = 'quit' , group='awesome'})                               ,
